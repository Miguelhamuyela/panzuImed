        ...
        <div class="card-deck mb-4">
            ...
            <div class="card border-0 bg-transparent">
                <div class="card-img-top img-fluid rounded"
                    style='background-image:url("/storage/{{ $services->image }}");background-position:center;background-size:cover;height:200px;'>
                </div>
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="title" id="title" value="{{ isset($services->title) ? $services->title : old('title') }}"
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <textarea name="body" id="editor1" style="min-height:300px; min-width:100%" >
                {{ isset($services->body) ? $services->body : old('body')}}
            </textarea>
        </div>
    </div>
</div>
