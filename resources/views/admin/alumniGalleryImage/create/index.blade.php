...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <form action='{{ url("admin/galeria-alumni-imagem/store/$gallery->id") }}' enctype="multipart/form-data" method="POST" class="row">
                @csrf
                @include('forms._formAlumniGalleryImage.index')
                <div class="col-md-12">
