    ...
    <div class="card mb-2">
        <div class="card-body">
            <h2 class="h5 page-title">
                <a href="{{ route('admin.alumniGallery.index') }}"><u>Listar Galerias</u></a> > {{ $gallery->name }}
            </h2>
        </div>
    </div>
                        ...
                        <div class="row align-items-center my-4">
                            ...
                            <div class="col-auto">
                                <a type="button" class="btn btn-lg btn-primary text-white"
                                    href="{{ url("admin/imageGalleryAlumni/create/{$gallery->id}") }}">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1"
                                                        ...
                                                        <a class="dropdown-item"
                                                            href='{{ url("admin/imageGalleryAlumni/delete/$item->id") }}'>{{ $item->id }}
                                                            - Eliminar</a>
                                                    </div>
                                                </div>
                                            </div>
